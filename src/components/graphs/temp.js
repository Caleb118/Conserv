        ...
        if (active) {
            ...
            <div className="card border-primary mb-3">
                ...
                <div className="card-body">
                    <p className="card-text"><b>Average Temp:</b> { !payload[0].value ? 0 : payload[0].value }</p>
                    <p className="card-text"><b>Minimum Temp:</b> { !payload[1].value ? 0 : payload[1].value }</p>
                    <p className="card-text"><b>Maximum Temp:</b> { !payload[2].value ? 0 : payload[2].value }</p>
                </div>
            </div>
            );
        }
        ...
        renderLineChart = (
            <ResponsiveContainer width={'90%'} aspect={2}>
                <ComposedChart data={smalldata}>
                    ...
                    <Area type="monotone" connectNulls dataKey="range_rh"  fill="#ffb0b0" stroke="#ffb0b0" name="Temperature Range" />
